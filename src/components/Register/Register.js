				  ...
				  <form className="measure">
				    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
				      ...
				      <div className="mt3">
				        ...
				        <input className="pa2 br3 input-reset white ba b--black-10 w-100" type="text" name="name"  id="name"/>
				      </div>
				      <div className="mt3">
				    ...
				    <div className="">
				      <input onClick={() => onRouteChange("home")} id="submit" className="b ph3 pv2 input-reset ba br3 b--black-10 grow white pointer f6 dib" type="submit" value="Register"/>
				    </div>
				  </form>
				</main>
			</article>
